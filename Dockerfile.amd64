# Built with arch: arm64 flavor: lxde image: ubuntu:jammy-20220531
#
################################################################################
# base system
################################################################################
...
FROM --platform=amd64 ubuntu:jammy-20220531 as amd64
RUN apt-get update && apt-get install -y qemu-user-static
FROM --platform=arm64 ubuntu:jammy-20220531 as system
...
FROM --platform=arm64 ubuntu:jammy-20220531 as builder
